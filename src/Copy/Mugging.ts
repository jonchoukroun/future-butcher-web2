const muggingRunVictory = [
    ...
    "You sprint like death is chasing you. Considering the rabid mugger and their rusty blade, who can blame you?",
];
...
export function getDefeatCopy(hoursLost: number, damageTaken: number) {
    const copy = [
        ...
        `They gave you the ass kicking of a lifetime and left you bleeding in the street for ${hoursLost} ${pluralize(
            hoursLost,
        )}.`,
